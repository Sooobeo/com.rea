...
def main() -> int:
    ...
    snapshot = {
        ...
        "official_observation": {
            ...
            "surface": "KIND stock-price page and DART listed-share cross-check",
            "url": "https://kind.krx.co.kr/common/stockprices.do?isurCd=09287&method=searchStockPricesMain",
            "lookup_condition": f"ticker=092870; completed-session close for {args.trade_date}; observed on KIND with its 20-minute delay notice",
            ...
            "capture_method": "read-only KIND observation recorded by this script; listed shares are independently reconciled to the latest DART periodic filing",
        },
